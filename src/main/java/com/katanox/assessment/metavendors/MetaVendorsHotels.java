...
// In the assessment is called Integration, but "MetaVendorsHotels" give more information in the
// class name and is more correct in terms of Clean Code

@Data
@Entity
public class MetaVendorsHotels {

  @EmbeddedId private MetaVendorsHotelsId id;
